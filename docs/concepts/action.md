...
Собственное символьное имя рекомендуется задавать ключом перевода, а затем уже использовать Translator 
для корректного перевода в человеко-читаемый вид.
...
- Стандартный способ определения символьного имени бизнес-процесса действия, исходя из атрибута `#[AsAction]`
